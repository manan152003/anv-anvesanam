  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        alignItems: 'center',
        padding: isMobileView ? '80px 16px 24px' : '120px 40px 40px',
        position: 'relative',
        zIndex: 1,
        maxWidth: '1400px',
        margin: '0 auto',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width={isMobileView ? '24' : '32'} height={isMobileView ? '24' : '32'} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div style={{
            ...
            <button
              onClick={() => navigate('/')}
              style={{
                padding: isMobileView ? '8px 16px' : '12px 32px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Title Section */}
            <div style={{ marginBottom: isMobileView ? '24px' : '40px' }}>
              <label style={{
                display: 'block',
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <textarea
                  ...
                  style={{
                    width: '100%',
                    height: isMobileView ? '120px' : '150px',
                    background: 'rgba(223, 208, 184, 0.05)',
                    borderRadius: isMobileView ? '12px' : '16px',
                    color: '#DFD0B8',
                    fontSize: isMobileView ? '14px' : '16px',
            ...
            <div style={{ marginBottom: isMobileView ? '24px' : '40px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  ...
                  <svg width={isMobileView ? '20' : '24'} height={isMobileView ? '20' : '24'} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {categoryDropdown && (
                  <div style={{
                    ...
                    boxShadow: '0 10px 30px rgba(0, 0, 0, 0.3)',
                    zIndex: 100,
                    maxHeight: isMobileView ? '200px' : '300px',
                    overflowY: 'auto'
                  }}>
                    {categories.map(cat => (
                      <div

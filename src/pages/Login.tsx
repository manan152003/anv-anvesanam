  ...
  return (
    <div className="min-h-screen bg-[#141414] flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 bg-[#1F1F1F] p-8 rounded-lg shadow-lg">
        <div>
          <h2 className="text-center text-3xl font-bold text-[#DFD0B8]">Sign in to your account</h2>
        </div>
        {error && (
        ...
        <div className="text-center">
          <p className="text-[#DFD0B8]">
            ...
            <Link to="/signup" state={{ from, url }} className="text-[#DFD0B8] hover:text-[#C4B5A0] underline">
              Sign up
            </Link>
          </p>
        </div>
